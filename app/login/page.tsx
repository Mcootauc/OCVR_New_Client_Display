...
export default function LoginPage() {
  const { user, signInWithGoogle, isLoading, isAuthorized } = useAuth()
    ...
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <Card className="w-full max-w-md border-blue-900/20">
        <CardHeader className="space-y-1 text-center">
          <CardTitle className="text-2xl font-bold">Pet Client Manager</CardTitle>
          <CardDescription>Sign in with your Google account to access the client dashboard</CardDescription>
        </CardHeader>
